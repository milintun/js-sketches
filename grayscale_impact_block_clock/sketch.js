...
function draw() {
  ...
  fill("white")
  textSize(46)
  text(timeFormat("h"), 0, 437 - remap(hour(), 0, 23, 0, 400))
  ...
  fill("white")
  textSize(29)
  text(timeFormat("m"), 200, 423 - remap(minute(), 0, 59, 0, 400))
  
  fill(gray(70))
  rect(350, 0, 50, 400)
  fill(gray(100))
  rect(350, 400, 50, -remap(smoothSecond(), 0, 60, 0, 400))
  
  fill("white")
  textSize(9)
  text(timeFormat("s"), 350, 407 - remap(smoothSecond(), 0, 60, 0, 400))
}